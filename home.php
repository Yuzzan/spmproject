...
<section class="category">
   ...
   <a href="category.php?category=accessory" class=" slide">
      <img src="images/icon-4.png" alt="">
      <h3>Accessories</h3>
   </a>

   <a href="category.php?category=appliance" class="slide">
